...
Item {
    ...
    signal passwordFocusChanged(bool focused)
    ...
    property bool isSelectingUser: state === "selectingUser"
    ...
    Item {
        id: loginContainer
        width: Config.loginAreaPosition === "left" || Config.loginAreaPosition === "right" ? (Config.avatarActiveSize * Config.generalScale + Config.usernameMargin * Config.generalScale + loginArea.width) : userSelector.width
        ...
        Item {
            id: noUsersLoginArea
            width: Config.passwordInputWidth * Config.generalScale + (loginButton.visible ? Config.passwordInputHeight * Config.generalScale + Config.loginButtonMarginLeft * Config.generalScale : 0)
            height: childrenRect.height
            visible: false
            ...
            Input {
                ...
                anchors {
                    ...
                    topMargin: Config.usernameMargin * Config.generalScale
                }
                width: parent.width
        ...
        UserSelector {
            ...
            onOpenUserList: { safeStateChange("selectingUser"); }
            onCloseUserList: {
                safeStateChange("normal");
        ...
        Item {
            id: loginLayout
            height: activeUserName.height + Config.passwordInputMarginTop * Config.generalScale + loginArea.height
            ...
            Component.onCompleted: {
                if (Config.loginAreaPosition === "left") {
                    ...
                    if (userSelector.visible) {
                        ...
                        anchors.leftMargin = Config.usernameMargin * Config.generalScale;
                    } else {
                        anchors.left = parent.left;
                    }
                } else if (Config.loginAreaPosition === "right") {
                    ...
                    if (userSelector.visible) {
                        ...
                        anchors.rightMargin = Config.usernameMargin * Config.generalScale;
                    } else {
                        anchors.right = parent.right;
                    }
                } else {
                    anchors.top = userSelector.bottom;
                    anchors.topMargin = Config.usernameMargin * Config.generalScale;
                    anchors.horizontalCenter = parent.horizontalCenter;
                }
            }
            ...
            RowLayout {
                ...
                spacing: Config.loginButtonMarginLeft * Config.generalScale
                visible: loginScreen.state !== "authenticating"

                Component.onCompleted: {
                    anchors.top = activeUserName.bottom;
                    anchors.topMargin = Config.passwordInputMarginTop * Config.generalScale;
                    if (Config.loginAreaPosition === "left") {
                        anchors.left = parent.left;
                    } else if (Config.loginAreaPosition === "right") {
                        anchors.right = parent.right;
                ...
                Input {
                    ...
                    Connections {
                        ...
                        function onActiveFocusChanged() {
                            loginScreen.passwordFocusChanged(password.input.activeFocus);
                        }
                    }
                }
            ...
            Text {
                ...
                anchors.topMargin: visible ? Config.warningMessageMarginTop * Config.generalScale : 0
                ...
                Behavior on anchors.topMargin { enabled: Config.enableAnimations; NumberAnimation { duration: 150 } }
                Behavior on opacity { enabled: Config.enableAnimations; NumberAnimation { duration: 150 } }
