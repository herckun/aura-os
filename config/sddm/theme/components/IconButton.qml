...
Item {
    ...
    property color contentColor: Config.textSecondaryColor
    property color activeContentColor: Config.textPrimaryColor
    property string label: ""
    property bool showLabel: true
    property string fontFamily: Config.themeFontFamily
    property int fontWeight: 400
    property int fontSize: 10
    property color backgroundColor: Config.backgroundSecondaryColor
    property double backgroundOpacity: 0.0
    property color activeBackgroundColor: Config.backgroundSecondaryColor
    property double activeBackgroundOpacity: 0.20
    property string tooltipText: ""
    property int borderRadius: Config.themeRadiusUI
    property int borderRadiusLeft: borderRadius
    property int borderRadiusRight: borderRadius
    property int borderSize: 0
    property color borderColor: isActive ? Config.accent : Config.borderColor
    ...
    Rectangle {
        ...
        radius: iconButton.borderRadius * Config.generalScale
    ...
    Rectangle {
        ...
        border {
            ...
            width: iconButton.focus ? Math.max(1, iconButton.borderSize * Config.generalScale) : (iconButton.borderSize > 0 ? (iconButton.borderSize * Config.generalScale) : 0)
        }
    }
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            MultiEffect {
                ...
                Behavior on colorizationColor { enabled: Config.enableAnimations; ColorAnimation { duration: 250 } }
            }
        }
