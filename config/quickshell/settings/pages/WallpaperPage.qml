...
Column {
  ...
  property var historyModel: {
    ...
    result.push({ path: "", time: 0, isPickMore: true })
    return result
  }
  ...
  RowLayout {
    ...
    Item {
      ...
      Text {
        anchors { left: parent.left; bottom: parent.bottom; leftMargin: Theme.spaceSm; bottomMargin: Theme.spaceXs }
      ...
      Rectangle {
        anchors { right: parent.right; top: parent.top; rightMargin: Theme.spaceSm; topMargin: Theme.spaceSm }
    ...
    Flow {
      ...
      Repeater {
        ...
        delegate: Item {
          ...
          Rectangle {
            id: currentBadge
            anchors { right: parent.right; top: parent.top; rightMargin: Theme.spaceXs; topMargin: Theme.spaceXs }
            width: 20; height: 20
            radius: Theme.radiusSmall
            color: Theme.accent
  ...
  Card {
    ...
    GridLayout {
      ...
      Repeater {
        model: [
          { name: "PRIMARY", col: WallpaperService.primary },
          { name: "SECONDARY", col: WallpaperService.secondary },
          { name: "TERTIARY", col: WallpaperService.tertiary },
          { name: "ACCENT", col: WallpaperService.accent },
          { name: "BG", col: WallpaperService.background },
          { name: "SURFACE", col: WallpaperService.surface },
          { name: "LIGHT", col: WallpaperService.primaryLight },
          { name: "DARK", col: WallpaperService.primaryDark }
        ]
        ...
        delegate: ColorSwatch {
          ...
          onClicked: {
            if (modelData.col) Theme.setAccent(modelData.col.toString())
          }
        }
      }
    }
